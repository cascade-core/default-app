...
app_init_file[]		= plugin/azure/init.php
...
cascade_graph_file	= "{AZURE_DATA_DIR}graphviz/cascade-{hash}.{ext}"
cascade_graph_url	= "{AZURE_DATA_URL}graphviz/cascade-{hash}.{ext}"
cascade_graph_doc_link	= "/documentation/block/{block}"
profiler_stats_file	= "{AZURE_VAR_DIR}profiler.stats"
